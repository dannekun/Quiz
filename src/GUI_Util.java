...
public class GUI_Util extends JFrame{
    ...
    public void buttonSetFontForegBackg(JButton button, int fontType, int fontSize,int rForeg, int gForeg, int bForeg,
                                              int rBackg, int gBackg, int bBackg){
        button.setFont(new Font("Arial", fontType, fontSize));
    ...
    public void buttonSetFontForeg_white(JButton button, int fontType, int fontSize){
        button.setFont(new Font("Arial", fontType, fontSize));
        button.setForeground(Color.WHITE);
        button.setOpaque(true);
    }
