...
public class Math {
    ...
    private final Questions Q4 = new Questions("<html>Du hade 342 mynt i sin samling. Hur skulle du skriva 342?</html>", A4);

    private final Questions Q5 = new Questions("<html>Om du hade 785 hundar hur många skulle du ha om jag tog 524?</html>", A5);

    private final Questions Q6 = new Questions("<html>Om Johanna hade 19,27kr och Max hade 13,59kr hur mycket mer pengar har Johanna?</html>", A6);
